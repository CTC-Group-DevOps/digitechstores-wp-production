	...
	class WC_Conditional_Content {
		...
		public function __construct() {
			...
			if ( is_admin() || defined( 'DOING_AJAX' ) ) {
				...
				include 'classes/inputs/text-text.php';
		...
		public function default_rule_types( $types ): array {
			$types = array(
				...
				__( 'Product', 'wc_conditional_content' )  => array(
					...
					'product_tag'       => __( 'Product Tag', 'wc_conditional_content' ),
					'product_price'     => __( 'Product Price', 'wc_conditional_content' ),
					'product_custom_field' => __( 'Product Custom Field', 'wc_conditional_content' ),
				),
				__( 'Schedule', 'wc_conditional_content' ) => array(
					'schedule_date' => __( 'Date', 'wc_conditional_content' ),
					'schedule_day'  => __( 'Day', 'wc_conditional_content' ),
					'schedule_time' => __( 'Time', 'wc_conditional_content' ),
				),
				...
				__( 'Membership', 'wc_conditional_content' ) => array(
					...
					'users_authentication' => __( 'Authentication', 'wc_conditional_content' ),
				),
				__( 'Store', 'wc_conditional_content' )    => array(
					'store_order_count' => __( 'Order Count and Status', 'wc_conditional_content' ),
					'store_order_history' => __( 'Ordered Product(s)', 'wc_conditional_content' ),
				),
				__( 'Cart', 'wc_conditional_content' )     => array(
					...
					'cart_line_item_quantity' => __( 'Cart Line Item Quantity', 'wc_conditional_content' ),
				),
				__( 'Geography', 'wc_conditional_content' ) => array(
					'geo_country_code' => __( 'Country', 'wc_conditional_content' ),
					'wpml_language'    => __( 'WPML Language Code', 'wc_conditional_content' ),
				),
				...
				'single-product' => array(
					...
					'hooks'       => array(
						...
						'woocommerce_after_single_product_summary' => array(
							...
							'priority'    => 0,
							'title'       => __( 'After single product summary', 'wc_conditional_content' ),
							'description' => '',
						),
						'woocommerce_show_product_sale_flash' => array(
							'action'      => 'woocommerce_before_single_product_summary',
							'priority'    => 11,
							'title'       => __( 'Before sale flash', 'wc_conditional_content' ),
							'description' => '',
						),
						'woocommerce_show_product_images'  => array(
							'action'      => 'woocommerce_before_single_product_summary',
							'priority'    => 21,
							'title'       => __( 'Before product images', 'wc_conditional_content' ),
							'description' => '',
						),
