...
(function($){
	...
	$( document ).ready(function() {
		...
		// Dismiss review notification temporary
		$('body').on('click', '.b2bking_dismiss_review_notice button.button-secondary, .b2bking_dismiss_review_notice button.notice-dismiss', function(){
			
			// Run ajax function that permanently dismisses notice
			if (!$(this).hasClass('b2bking_review_notice_button_permanent')){
				var datavar = {
		            action: 'b2bking_dismiss_review_admin_notice_temporary',
		            security: b2bking_notice.security,
		        };
