...
(function($){
	...
	$( document ).ready(function() {
		...
		function updateDynamicRulesOptionsConditions(){
			...
			// Hide tax name
			$('#b2bking_container_taxname, #b2bking_container_tax_taxable, #b2bking_container_tax_shipping, #b2bking_container_tax_shipping_rate, #b2bking_container_tiered_price').css('display','none');
