...
use WPDesk\FCF\Pro\Settings\Option\LogicInfoWcOption;
...
use WPDesk\FCF\Free\Field\Type\Wc\WcCountryType as DefaultWcCountryType;

/**
 * {@inheritdoc}
 */
class WcCountryType extends DefaultWcCountryType {
