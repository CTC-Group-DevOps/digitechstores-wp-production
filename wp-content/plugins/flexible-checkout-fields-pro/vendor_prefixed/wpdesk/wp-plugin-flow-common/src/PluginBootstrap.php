...
namespace FCFProVendor\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-checkout-fields-pro';
     ...
     */
    private function init_translations(\FCFProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FCFProVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FCFProVendor\WPDesk_Plugin_Info();
