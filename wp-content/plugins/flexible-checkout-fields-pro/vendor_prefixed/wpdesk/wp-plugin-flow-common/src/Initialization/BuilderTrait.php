...
namespace FCFProVendor\WPDesk\Plugin\Flow\Initialization;

use FCFProVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use FCFProVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
use FCFProVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
use FCFProVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\FCFProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\FCFProVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
