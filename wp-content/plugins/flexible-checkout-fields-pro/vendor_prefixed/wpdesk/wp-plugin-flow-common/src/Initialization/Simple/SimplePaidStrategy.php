...
use FCFProVendor\WPDesk\Helper\HelperRemover;
use FCFProVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use FCFProVendor\WPDesk\License\PluginRegistrator;
use FCFProVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use FCFProVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use FCFProVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use FCFProVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use FCFProVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use FCFProVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\FCFProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\FCFProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
