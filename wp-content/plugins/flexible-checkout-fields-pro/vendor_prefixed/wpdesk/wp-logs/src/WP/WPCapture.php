...
namespace FCFProVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    private function add_notice_for_dir($dir)
    {
        new \FCFProVendor\WPDesk\Notice\Notice(sprintf(
            ...
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-checkout-fields-pro'),
            $dir
        ), \FCFProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \FCFProVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-checkout-fields-pro'),
            $file
        ), \FCFProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
