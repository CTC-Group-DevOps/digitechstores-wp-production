...
use FCFProVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use FCFProVendor\Monolog\Logger;
use FCFProVendor\Monolog\Formatter\FormatterInterface;
use FCFProVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FCFProVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FCFProVendor\Elasticsearch\Client;
use FCFProVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FCFProVendor\Elastic\Elasticsearch\Client as Client8;
/**
