...
use FCFProVendor\Monolog\Formatter\LineFormatter;
use FCFProVendor\Monolog\Formatter\FormatterInterface;
use FCFProVendor\Monolog\Logger;
use FCFProVendor\Monolog\Utils;
use FCFProVendor\PhpConsole\Connector;
use FCFProVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use FCFProVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('FCFProVendor\PhpConsole\Connector')) {
