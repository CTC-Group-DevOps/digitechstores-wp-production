...
namespace FCFProVendor\Psr\Log\Test;

use FCFProVendor\Psr\Log\LoggerInterface;
use FCFProVendor\Psr\Log\LogLevel;
use FCFProVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FCFProVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FCFProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FCFProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
