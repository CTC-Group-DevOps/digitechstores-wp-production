 ...
 * Documentation URI: https://docs.woocommerce.com/document/woocommerce-admin-custom-order-fields/
 ...
 *
 * Copyright: (c) 2012-2026, SkyVerge, Inc. (info@skyverge.com)
 *
 ...
 *
 * Woo: 272218:31cde5f743a6d0ef83cc108f4b85cf8b
...
/**
 * WooCommerce Admin Custom Order Fields Loader.
 *
 * @since 1.11.0
 */
class WC_Admin_Customer_Order_Fields_Loader {
	...
	public const FRAMEWORK_VERSION = '6.2.0';

	/** the plugin name, for displaying notices */
	public const PLUGIN_NAME = 'WooCommerce Admin Custom Order Fields';


	/** @var \WC_Admin_Customer_Order_Fields_Loader|null single instance of this class */
	protected static ?WC_Admin_Customer_Order_Fields_Loader $instance = null;
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-admin-custom-order-fields.php' );
	 ...
	 * @since 1.11.0
	 *
	 * @return \WC_Admin_Customer_Order_Fields_Loader
	 */
	public static function instance() : WC_Admin_Customer_Order_Fields_Loader
	{
...
// fire it up!
WC_Admin_Customer_Order_Fields_Loader::instance();
