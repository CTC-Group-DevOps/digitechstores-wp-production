...
<tr class="wc-custom-order-field">
	...
	<td class="check-column">
		<input type="checkbox" />
		<input type="hidden"
		       name="wc-custom-order-field-id[<?php echo esc_attr( $index ); ?>]"
		       value="<?php echo esc_attr( $field_id ); ?>" />
	</td>

	<td class="wc-custom-order-field-label">
		<input type="text"
		       name="wc-custom-order-field-label[<?php echo esc_attr( $index ); ?>]"
		       value="<?php echo esc_attr( isset( $field->label ) ? $field->label : null ); ?>"
		       class="js-wc-custom-order-field-label" />
		<span class="wc-custom-order-field-id"><?php echo $field_id ? 'ID: ' .  esc_html( $field_id ) : ''; ?></span>
	</td>

	<td class="wc-custom-order-field-type">
		<select name="wc-custom-order-field-type[<?php echo esc_attr( $index ); ?>]"
	...
	<td class="wc-custom-order-field-description">
		<input type="text"
		       name="wc-custom-order-field-description[<?php echo esc_attr( $index ); ?>]"
	...
	<td class="wc-custom-order-field-default-values">
		<input type="text"
		       name="wc-custom-order-field-default-values[<?php echo esc_attr( $index ); ?>]"
	...
	<td class="wc-custom-order-field-attributes">
		<select name="wc-custom-order-field-attributes[<?php echo esc_attr( $index ); ?>][]"
	...
	<td class="js-wc-custom-order-field-draggable">
		<img src="<?php echo esc_url( wc_admin_custom_order_fields()->get_plugin_url() ) ?>/assets/images/draggable-handle.png" />
	</td>
